package com.technomatesoftware.ergostats.ui.theme
...
val md_theme_light_secondary = Color(0xFF4E50C3)
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFE1DFFF)
val md_theme_light_onSecondaryContainer = Color(0xFF08006C)
...
val md_theme_dark_secondary = Color(0xFFC1C1FF)
val md_theme_dark_onSecondary = Color(0xFF1C1794)
val md_theme_dark_secondaryContainer = Color(0xFF3635AA)
val md_theme_dark_onSecondaryContainer = Color(0xFFE1DFFF)
val md_theme_dark_tertiary = Color(0xFFFCBC0C)
...
val seed = Color(0xFFFE9F07)

val CorrectGreen: Color
    @Composable
    get() = if (isSystemInDarkTheme()) Color(0xFF2ED159) else Color(0xFF1C7D36)

val WrongRed: Color
    @Composable
    get() = if (isSystemInDarkTheme()) Color(0xFFFF453B) else Color(0xFF992923)